//PROJECT ON SPORTS ACADEMY
#include<conio.h>
#include<fstream.h>
#include<stdio.h>
#include<process.h>
//**********************************************************
// CLASS NAME : Yamuna Sports Academy
// DETAILS    : IT CONTROLS OVER ALL FUNCTIONING
//                   OF THE YAMUNA SPORTS ACADEMY
//**********************************************************
class yamuna
{
    int  age;
...
<<"\n\talso  has the  privilege of producing many of the famous sporting"
...
// FOR GOING TO THE SPECIFIED OPTION 
  ...
  if(h==6)
  {
   ...
   goto mainmenu;
   cout<<"\n\n\t      Press any key other than enter to continue ";
   cin>>j;
   goto mainmenu;
  getch();
  }
